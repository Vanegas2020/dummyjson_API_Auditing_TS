...
test.describe('Endpoint: GET /users?limit=10&skip=0', () => {
  ...
  test('[CP-GEN-10] GET /users?limit=10&skip=0 - No Authentication Required', async ({ api }) => {
  ...
  test('[CP-SEC-06] GET /users?limit=10&skip=0 - Injection via Query String Rejected', async ({ api }) => {
  ...
  test('[CP-AUD-07] GET /users?limit=10&skip=0 - Duplicate Query Params Do Not Cause 500', async ({ api }) => {
      ...
      const url = '/users?limit=10&skip=0&id=1&id=2&id=999&limit=10&limit=9999';
